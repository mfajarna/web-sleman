      ...
      <div class="left">
        <div class="calendar">
          <div class="month">
            ...
            <div class="date">desember 2015</div>
          ...
          <div class="goto-today">
            <div class="goto">
              ...
              <button class="goto-btn">Selanjutnya</button>
            </div>
      ...
      <div class="right">
        ...
        <div class="add-event-wrapper">
          <div class="add-event-header">
            <div class="title">Tambah acara</div>
...
addEventNamaPenyewa = document.querySelector('.event-penyewa');
...
function getActiveDay(date) {
const day = new Date(year, month, date);
const dayName = getIndonesianDayName(day); // Mengambil nama hari dalam bahasa Indonesia
eventDay.innerHTML = dayName;
eventDate.innerHTML = date + " " + months[month] + " " + year;
}

// Fungsi untuk mengubah nama hari dalam bahasa Inggris menjadi dalam bahasa Indonesia
    ...
    event.events.forEach((event) => {
      events += `<div class="event">
          <div class="title">
            ...
            <h3 class="event-title">${event.namaPenyewa}</h3>
            <h3 class="event-title">${event.instansi}</h3>
            <h3 class="event-title">${event.jadwal}</h3>
          </div>
...
addEventNamaPenyewa.addEventListener("input", (e) => {
  addEventNamaPenyewa.value = addEventNamaPenyewa.value.slice(0, 60);
});
...
osccred.innerHTML =
  "A Project By <a href= target=_blank>nvii project</a>";
...
const eventNamaPenyewa = addEventNamaPenyewa.value;
const eventInstansi = addEventInstansi.value;
const eventJadwal = addEventJadwal.value;
const eventTimeFrom = addEventFrom.value;
const eventTimeTo = addEventTo.value;
if (eventTitle === "" || eventTimeFrom === "" || eventTimeTo === "" || eventNamaPenyewa === "" || eventInstansi === "" || eventJadwal === "" ) {
